...
function Getters() {
  ...
  return function (target) {
    ...
    for (var _i = 0; _i < propertyNames.length; _i++) {
      var property = propertyNames[_i];
...
function Setters() {
  ...
  return function (target) {
    ...
    for (var _i2 = 0; _i2 < propertyNames.length; _i2++) {
      var property = propertyNames[_i2];
...
function Properties() {
  ...
  return function (target) {
    ...
    for (var _i3 = 0; _i3 < propertyNames.length; _i3++) {
      var property = propertyNames[_i3];
