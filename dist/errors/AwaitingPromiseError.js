...
function (_Error) {
  ...
  function AwaitingPromiseError(error, fileName) {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(AwaitingPromiseError).call(this, message || error, fileName, lineNumber));
